/****************************************************************************
 * boards/arm/stm32h7/vzlu-ulsdc/include/board.h
 *
...
#ifndef __BOARDS_ARM_STM32H7_VZLU_ULSDC_INCLUDE_BOARD_H
#define __BOARDS_ARM_STM32H7_VZLU_ULSDC_INCLUDE_BOARD_H
...
/* The VZLU ULSDC board provides the following clock sources:
 *
...
/* USART2 General Purpose RS-232 / RS-485 Port 1 */

#define GPIO_USART2_RX    (GPIO_USART2_RX_1 | GPIO_SPEED_100MHz) /* PA3 */
#define GPIO_USART2_TX    (GPIO_USART2_TX_2 | GPIO_SPEED_100MHz) /* PD5 */
#define GPIO_USART2_RTS   (GPIO_USART2_RTS_2 | GPIO_SPEED_100MHz) /* PD4 */
#define GPIO_USART2_RS485_DIR (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_100MHz|\
...
/* USART3 General Purpose RS-232 / RS-485 Port 1  */

#define GPIO_USART3_RX    (GPIO_USART3_RX_3 | GPIO_SPEED_100MHz) /* PD9 */
#define GPIO_USART3_TX    (GPIO_USART3_TX_3 | GPIO_SPEED_100MHz) /* PD8 */
#define GPIO_USART3_RTS   (GPIO_USART3_RTS_2 | GPIO_SPEED_100MHz) /* PD12 */
#define GPIO_USART3_RS485_DIR (GPIO_OUTPUT|GPIO_PUSHPULL|GPIO_SPEED_100MHz|\
...
/* I2C2 with FM24CL16B-G connected */
...
#define GPIO_CAN1_RX      (GPIO_CAN1_RX_3 | GPIO_SPEED_100MHz)  /* PD0 */
#define GPIO_CAN1_TX      (GPIO_CAN1_TX_3 | GPIO_SPEED_100MHz)  /* PD1 */

/* CAN1 */

#define GPIO_CAN2_RX      (GPIO_CAN2_RX_2 | GPIO_SPEED_100MHz)  /* PB5 */
#define GPIO_CAN2_TX      (GPIO_CAN2_TX_2 | GPIO_SPEED_100MHz)  /* PB6 */
...
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_ARM_STM32H7_VZLU_ULSDC_INCLUDE_BOARD_H */
