...
This README discusses issues unique to NuttX configurations for the Revitest
ANCA L476RE board from Revitest/Electroline/PiKRON.
...
================================
  ...
  1. You must have already configured Nuttx in <some-dir>/nuttx.
     ...
     $ tools/configure.sh anca-l476re:nsh
     $ make qconfig
...
=======
  ...
  2014-12-04:
    ...
    - There is conflicts with some of the Arduino data pins and the
      ...
      but with CONFIG_ANCA_L476RE_AJOY_MINBUTTONS to eliminate the
      conflict.
...
===============================
  ...
  as written before.
  Configuring can be done by using ./tools/configure.sh anca-l476re/spimmcsd
